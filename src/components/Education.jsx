  ...
  return (
    <section id="education" className="py-10 bg-base-200">
      <div className="md:w-10/12 mx-auto px-8 md:px-0">
        ...
        <div className="w-full mx-auto bg-base-100 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col sm:flex-row items-center sm:items-start gap-6">
